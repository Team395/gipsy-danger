...
public class Robot extends TimedRobot {
	...
	*/
	...
	public void testPeriodic() {
		int solenoidToFire = (int) SmartDashboard.getNumber("SolenoidToFire", 0);
		SmartDashboard.putNumber("SolenoidFiring", solenoidToFire);
		for(int i = 0; i < 8; i++) {
			solenoids.get(i).set(i == solenoidToFire);
		}
	}
}
